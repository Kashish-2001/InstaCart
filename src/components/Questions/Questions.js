                ...
                {questions.map(({question, answer}) => {
                  return (
                         <div className={styles.QuestionBox}>
                                <Fragment>
                                    <div onClick={handleClick} className={`${styles.questionBoxInner} center`}>
                                        <div className={styles.question}><p>{question}</p></div>
                                        <div className={`${!click && styles.sign} ${click && styles.hide}`}>+</div>
                                        <div className={`${!click && styles.hide} ${click && styles.sign}`}>-</div>
                                    </div>
